...
save(SCVI, SCVI.res,
     file="../../../Data/cellbench_SCVI_benchmark_results.RData")
```

```{r}
##### run M3Drop
M3DROP <- doM3Drop(logcounts(sce_10x_log), cty) 
M3DROP.res <- getStats(M3DROP, method="M3Drop")

save(M3DROP, M3DROP.res,
     file="../../../Data/cellbench_M3Drop_benchmark_results.RData")
```
